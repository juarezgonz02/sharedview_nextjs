...
to {
  ...
  animation: ${X} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,M=({toast:e})=>{let{icon:r,type:n,iconTheme:l}=e;return void 0!==r?"string"==typeof r?f.createElement(L,null,r):r:"blank"===n?null:f.createElement(K,null,f.createElement(z,{...l}),"loading"!==n&&f.createElement(V,null,"error"===n?f.createElement(R,{...l}):f.createElement(U,{...l})))},ye=e=>`
