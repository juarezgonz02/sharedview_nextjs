...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_js_page_2Fsrc_2Fmiddleware_rootDir_D_3A_5CNueva_20carpeta_5Csharedview_nextjs_5CNextJS_20Proyect_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
const generateResponseWithCookie = (room, exp)=>{
    ...
    response.cookies.set({
        name: "sign",
        value: md5_default()(`/live/${room}-${exp}-${process.env.KEY}`),
        path: `/${room}`
    });
    response.cookies.set({
        name: "room-exp",
...
/* harmony default export */ const RoomMiddleware = (roomsMiddleware);
...
const homePageSessionMiddleware = async (request)=>{
    if (!request.cookies.has("token")) {
        return NextResponse.redirect(ENV_URL + "/login");
    }
    return NextResponse.next();
};
const loggedMiddleware = (request)=>{
    if (request.cookies.has("token")) {
        return NextResponse.redirect(ENV_URL + "/home");
    }
};
const clearCookies = ()=>{
    ...
    response.headers.set("Set-Cookie", "token=; expires=Sun, 06 Nov 1994 08:49:37 GMT; path=/;");
    return response;
};
...
async function middleware(request) {
    ...
    if (request.nextUrl.pathname.match("(?:[A-Za-z0-9]{3}-){2}[A-Za-z0-9]{3}")) {
        return RoomMiddleware(request);
    }
    return NextResponse.next();
}

;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.js&page=%2Fsrc%2Fmiddleware&rootDir=D%3A%5CNueva%20carpeta%5Csharedview_nextjs%5CNextJS%20Proyect&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_js_page_2Fsrc_2Fmiddleware_rootDir_D_3A_5CNueva_20carpeta_5Csharedview_nextjs_5CNextJS_20Proyect_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/src/middleware",
            handler,
...
(function() {
    var crypt = __webpack_require__(406), utf8 = (__webpack_require__(212).utf8), isBuffer = __webpack_require__(108), bin = (__webpack_require__(212).bin), // The core
